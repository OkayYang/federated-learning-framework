...
#### SCAFFOLD
SCAFFOLD（Stochastic Controlled Averaging for Federated Learning）使用方差减少技术，通过控制变量来纠正客户端更新的漂移，加速收敛并提高性能。SCAFFOLD通过修改梯度来纠正客户端漂移：$g_i ← g_i - c_i + c$，其中$g_i$是原始梯度，$c_i4是客户端控制变量，$c$是全局控制变量。实现中使用了梯度裁剪以提高稳定性。
